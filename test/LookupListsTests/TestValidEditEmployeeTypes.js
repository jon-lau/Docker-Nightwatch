module.exports = { // adapted from: https://git.io/vodU0
    'Valid Edit Employee Types Test': function (browser) {
        browser
    ...
    //create type
     .waitForElementVisible("ul div:nth-child(5) div a", 1000) //employee types
     .click("ul div:nth-child(5) div a")
    ...
    //edit type
     ...
     .assert.containsText("#parsley-id-5", "The employee type field is required.") //check
    //delete type
     .waitForElementVisible("div.right_col div a", 1000) //back to list
     .click("div.right_col div a")
     .waitForElementVisible("div.right_col div div.page-with-table-button a", 1000) //create new
